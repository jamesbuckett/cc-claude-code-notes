...
* After each turn, the condition and the conversation so far are handed to a small fast model (Haiku by default) that returns a yes-or-no decision and a short reason.
